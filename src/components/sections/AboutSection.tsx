  ...
  return (
    <div ref={containerRef} id="projects" className="relative w-full" style={{ height: '500vh' }}>
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-between bg-[#F4F0E8] select-none z-20">
        ...
        <motion.div
          style={{ x: trackX }}
          className="flex h-full w-[500vw] items-stretch flex-1"
        >
          {/* SLIDE 01: 2022 */}
          <div className="w-screen h-full shrink-0 flex items-center px-8 md:px-16 lg:px-24 bg-[#F4F0E8] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center w-full max-w-7xl mx-auto relative z-10">
              <div className="lg:col-span-7 space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#B85C3B]/10 border border-[#B85C3B]/20 text-[#B85C3B] text-xs font-mono tracking-widest uppercase font-bold">
          ...
          <div className="w-screen h-full shrink-0 flex items-center px-8 md:px-16 lg:px-24 bg-[#FAF8F3] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center w-full max-w-7xl mx-auto relative z-10">
              ...
              <div className="lg:col-span-7 space-y-6 order-1 lg:order-2">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#8E9A78]/10 border border-[#8E9A78]/20 text-[#8E9A78] text-xs font-mono tracking-widest uppercase font-bold">
          ...
          <div className="w-screen h-full shrink-0 flex items-center px-8 md:px-16 lg:px-24 bg-[#F4F0E8] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center w-full max-w-7xl mx-auto relative z-10">
              <div className="lg:col-span-7 space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#4A6FA5]/10 border border-[#4A6FA5]/20 text-[#4A6FA5] text-xs font-mono tracking-widest uppercase font-bold">
