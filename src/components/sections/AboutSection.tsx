...
export function JourneySection() {
  ...
  return (
    <div ref={containerRef} id="timeline" className="relative w-full" style={{ height: '500vh' }}>
      {/* STICKY FULLSCREEN VIEWPORT */}
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-between bg-[#F4F0E8] select-none z-20">
        
        {/* Fixed Header Bar across timeline pages */}
        <div className="flex items-center justify-between border-b border-[#E2DCD2] py-4 px-6 md:px-12 w-full z-40 bg-[#F4F0E8]/90 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <span className="text-xs font-mono tracking-[0.22em] text-[#B85C3B] font-bold">02</span>
            <div className="w-6 h-px bg-[#B85C3B]" />
            <span className="text-xs font-mono tracking-[0.2em] uppercase text-[#25231F] font-semibold">
              FULLSCREEN TIMELINE // HORIZONTAL FEATURE SHOWCASE
            </span>
          </div>
